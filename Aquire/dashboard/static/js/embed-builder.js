...
window.onload = () => {
    ...
    let editorHolder = document.querySelector('.editorHolder'),
        ...
        toRGB = (hex, reversed, integer) => {
            ...
            embed: {
                title: "Hello! :wave:",
                description: "You can use [links](https://syfer.aquire.tk) or emojis :smile: :eyes:\n```\nAnd also code blocks\n```",
                color: 4321431,
                timestamp: new Date().toISOString(),
                url: "https://syfer.aquire.tk",
                author: {
                    name: "Author name",
                    url: "https://syfer.aquire.tk",
                    icon_url: "https://images-ext-2.discordapp.net/external/UtHRRHy_ZNkfTWztkEVK6q7t3-b8PldFcXCaFJ3Wlh8/%3Fsize%3D512/https/cdn.discordapp.com/avatars/818385882641858612/209df0ed593b120298be0a1375bcaa11.webp?width=300&height=300"
                },
                thumbnail: {
...
if(command.length > 30) return error("Command length exceeds 30 characters.", 4000);
  ...
  error('Successfully saved command, if not saved, <a href="https://syfer.aquire.tk/embeds">read here</a>', 10000)
        e.preventDefault();
        $.ajax({
            type: "POST",
