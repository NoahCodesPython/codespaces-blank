...
module.exports = class extends Event {
  ...
  async run(message) {
    ...
    metrics.init({ apiKey: this.client.config.datadogApiKey, host: 'Aquire', prefix: '' });
      ...
      if (message.content.match(mentionRegex)) {
        ...
        const embed = new MessageEmbed()
          .setTitle('Hello, I\'m Aquire. What\'s Up?')
          .addField(`Prefix`,proofita, true)
          .addField(`Usage`,proofitaa, true)
          .setDescription(`\nIf you like Aquire, Consider [voting](https://top.gg/bot/818385882641858612), or [inviting](https://discord.com/oauth2/authorize?client_id=816987224662999040) it to your server! Thank you for using Aquire, we hope you enjoy it, as we always look forward to improve the bot`)
          .setFooter('Thank you for using Aquire!!')
          .setColor('#FF2C98')
...
message.channel.send(`Aquire is currently undergoing maintenance which won't allow anyone to access Aquire's Commands. Feel free to try again later. For updates: https://aquire.tk/server`)
