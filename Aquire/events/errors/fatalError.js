...
module.exports = class extends Event {
 ...
 message.channel.send(`${message.client.emoji.fail} Hey there. An error Just occured and will be reported.\n\`code: ${id}\`\n\nmake sure to report it here (important) https://discord.gg/bM4pkW6sJ6 `).catch(()=>{});
