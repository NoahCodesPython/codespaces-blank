...
module.exports = class extends Command {
  ...
  if(!channel) return message.channel.send(closed);
      await message.author.send(new discord.MessageEmbed().setColor(message.client.color.green).setFooter('Powered by syfer.aquire.tk').setDescription(`${message.client.emoji.success} | ${language.applaydone} **${message.guild.name}** [by clicking here](https://syfer.aquire.tk/apply/${message.guild.id})`))
