...
message.channel.send(new discord.MessageEmbed().setDescription(`${language.urlCreated}\n\n**Short Url:** [https://syfer.aquire.tk/url/${kaka}](https://syfer.aquire.tk/url/${kaka})\n**Full url:** ${args[0]}\n\n**Please note that by making urls you abide by our [policy](https://syfer.aquire.tk/url)**`).setColor(message.client.color.blue));
