...
module.exports = class extends Command {
    constructor(...args) {
      super(...args, {
        name: 'vote',
        description: 'Syfer\s vote pages',
        category: 'Utility',
        cooldown: 5
      });
    }
    ...
    async run(message) {
      ...
      .setDescription(`__**Top.gg**__\n${checkDBLVote ? `\`In ${ms(user.lastVoted - Date.now() + DBL_INTERVAL, { long: true })}\`` : '[\`Available Now!\`](https://top.gg/bot/818385882641858612/vote)'}\n\n__**Rewards:**__\n`)
