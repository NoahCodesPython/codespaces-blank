...
if(!suggestionName) return message.channel.send(new MessageEmbed().setAuthor(`${message.author.tag}`, message.author.displayAvatarURL({ format: 'png' })).setDescription(`${fail} ${language.suggest1}`).setFooter('https://syfer.aquire.tk').setTimestamp().setColor('RED'));
...
if(guildDB.suggestion.suggestionChannelID !== null){
  ...
  if(channelLog){
   ...
   icon: `https://cdn.discordapp.com/avatars/818385882641858612/209df0ed593b120298be0a1375bcaa11.webp?size=512`
 }).catch(()=>{})
  }
}
