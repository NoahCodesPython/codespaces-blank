...
module.exports = class extends Command {
    constructor(...args) {
      super(...args, {
        ...
        examples: [ 'help', 'help moderation', 'help ban' ],
        cooldown: 3
      });
    }
    ...
    const prefix = guildDB.prefix;
      ...
      const green = '<:greenstar:1364899627777659011>';
      ...
      if (!args || args.length < 1) {
       ...
       categories = this.client.utils.removeDuplicates(this.client.commands.filter(cmd => cmd.category !== 'Owner').map(cmd => cmd.category));
        ...
        embed.setTitle(`Aquire's Command List`)
        embed.setDescription(stripIndent`
        <:greenstar:1364899627777659011> The Prefix for this server is \`${prefix}\`
...
embed.addField(
        ...
        '[Support Server](https://discord.gg/tZARmUsnZU) | ' +
...
embed.addField(
        ...
        embed.setThumbnail(`https://cdn.discordapp.com/avatars/818385882641858612/209df0ed593b120298be0a1375bcaa11.webp?size=512`)
