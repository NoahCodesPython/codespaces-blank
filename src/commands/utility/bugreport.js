const { SlashCommandBuilder, ModalBuilder, TextInputBuilder, ActionRowBuilder, TextInputStyle, MessageFlags } = require('discord.js');
    ...
    async execute(interaction) {
        try {
            ...
            await interaction.reply({
                ...
                flags: 64 // Update to use MessageFlags for ephemeral messages
            });
        }
    }
};
